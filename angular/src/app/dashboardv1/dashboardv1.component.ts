...
export class Dashboardv1Component implements OnInit {
  ...
  public lineChartOptions:any = {
	...
	public lineChartData:Array<any> = [
	{
		...
		backgroundColor     : "rgba(13,169,239,1)",
		hoverBackgroundColor: "rgba(13,169,239,1)",
		borderColor         : '#0da9ef',
		borderWidth         : 2,
		pointRadius         : 4,
		pointHoverRadius    : 4,
	...
	public lineChartLabels:Array<any> = [
		"2017-10-21","2017-10-21","2017-10-21","2017-10-21","2017-10-21","2017-10-21","2017-10-21"
	];
  
  public lineChartColors:Array<any> = [
    {
      backgroundColor: 'rgba(13,169,239,0.2)',
      borderColor: '#0da9ef',
      pointBackgroundColor: '#fff',
      pointBorderColor: 'rgba(13,169,239,1)',
